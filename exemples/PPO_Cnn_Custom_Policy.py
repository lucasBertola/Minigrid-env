...
env = MiniGridEnv(size=SIZE, output_is_picture=True,pixel_max_value=2)
...
env = MiniGridEnv(render_mode="human", size=SIZE, output_is_picture=True,pixel_max_value=2)
